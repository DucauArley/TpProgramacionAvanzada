...
{	
	...
	public static void guardar(Object o) 
	{
		...
		{
			Columna col = f.getAnnotation(Columna.class);// Basicamente porque id no tiene @columna
	...
	public static void eliminar(Object o) 
	{
		...
		for(Field f: atributos) 
		{
			...
			if(id != null) 
			{
				columnaId = columnaId + "id = " + Ubean.ejecutarGet(o, f.getName());// No se como recuperar el valor de la anotation id
			}
		}
